...
<a href="${c[i].link[c[i].link.length-1].href}#comments"><svg class='line' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><polyline points='15 14 20 9 15 4'/><path d='M4 20v-7a4 4 0 0 1 4-4h12'/></svg>Reply</a>
<div data-title="${c[i].title.$t}" data-url="${c[i].link[c[i].link.length-1].href}" onclick="share(this)"><svg class="line" viewBox="0 0 24 24"><path d="M92.30583,264.72053a3.42745,3.42745,0,0,1-.37,1.57,3.51,3.51,0,1,1,0-3.13995A3.42751,3.42751,0,0,1,92.30583,264.72053Z" transform="translate(-83.28571 -252.73452)"></path><circle class="fill" cx="18.48892" cy="5.49436" r="3.51099"></circle><circle class="fill" cx="18.48892" cy="18.50564" r="3.51099"></circle><line class="cls-3" x1="12.53012" x2="8.65012" y1="8.476" y2="10.416"></line><line class="cls-3" x1="12.53012" x2="8.65012" y1="15.496" y2="13.556"></line></svg> Share</div>
<div data-des="${c[i].content.$t.replace(/<[^>]*>?/g, '').substring(0, 150) + '...'}" data-title="${c[i].title.$t}" data-url="${c[i].link[c[i].link.length-1].href}" onclick="addItem(this)"><svg preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3l7 3V5c0-1.1-.9-2-2-2z" fill="currentColor"></path></svg></div>
</div>
    ...
    <td>
      ...
      <div class="record">
        ...
        <div class="record-trans">
          ...
          <span class="record-line">${value.trText}</span>
        </div>
      </div>
    </td>
        `
